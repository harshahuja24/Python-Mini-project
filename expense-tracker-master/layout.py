...
"background-color:#888;")
        ...
        self.title = QtWidgets.QLabel(self.centralwidget)
        self.title.setGeometry(QtCore.QRect(0, 10, 525, 31))  
        font = QtGui.QFont()
        font.setPointSize(22)
        font.setBold(True)
        font.setItalic(True)  
        ...
        self.title.setText("Personal Expense Tracker")
...
"background-color:#888;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.title.setText(_translate("MainWindow", "Personal Expense Tracker"))
